        ...
        <ol className="flex items-center flex-wrap">
          ...
          <li>
            <Link
              ...
              className={`hover:text-green-600 transition ${
                selectedCategory ? "text-gray-400" : "text-black font-medium"
              }`}
            >
              Produk
            </Link>
          ...
          {selectedCategory && (
            <>
              ...
              <li className="text-black font-medium">{selectedCategory}</li>
            </>
          )}
        </ol>
      </nav>
        ...
        <div className="flex items-center justify-between mt-4 text-sm text-gray-600">
          ...
          <div className="flex items-center gap-3">
            <Select.Root value={sortBy} onValueChange={setSortBy}>
              ...
              <Select.Content>
                <Select.Item className="hover:bg-green-700!" value="terbaru">
                  Terbaru
                </Select.Item>
                <Select.Item className="hover:bg-green-700!" value="terlama">
                  Terlama
                </Select.Item>
                <Select.Item className="hover:bg-green-700!" value="termurah">
                  Termurah
                </Select.Item>
                <Select.Item className="hover:bg-green-700!" value="terlaris">
                  Terlaris
                </Select.Item>
              </Select.Content>
            </Select.Root>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
        ...
        <div className="md:col-span-3">
          <div
            className={
              view === "grid"
                ? " columns-2 md:columns-3 lg:grid lg:grid-cols-4 gap-3 space-y-3 lg:space-y-0"
                : "flex flex-col gap-4"
            }
          >
